  ...
  return (
    <div className="offers">
      ...
      <div className="offers-right">
        ...
        <span>
          For fully customized piece, simply send us an email with your idea,
          including any photos, colors, sizes, or special details you want. The
          more information you share, the closer we can bring your vision to
          life!
          <br /> We’ll review your request and get back to you with pricing,
          timing, and available options.
        </span>
