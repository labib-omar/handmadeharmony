...
export default function LegalNotice() {
  return (
    <div className="Legal-container">
      ...
      <h2>Contact</h2>
      <p>
        <strong>Phone:</strong> +49 170 555 0199
        <br />
      ...
      <h2>VAT ID</h2>
      <p>
        Value Added Tax Identification Number according to § 27 a German VAT
        Act:
        <br />
        <strong>DE999999999</strong> (replace with your real VAT ID if
        applicable)
      </p>
